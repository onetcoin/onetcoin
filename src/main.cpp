...
const string strMessageMagic = "onetcoin Signed Message:\n";
...
int64_t nSubsidy = 1 * COIN; //Miner reward
            ...
            if(nBestHeight <= 425)
            {
            nSubsidy = 100000 * COIN; //Total premine coin
            }
...
static const int64_t nTargetTimespan = 24 * 60 * 60;  // 24 hour 0 mins
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "onetcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "22jan2018";
        CTransaction txNew;
        txNew.nTime = 1516713674;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1516713674;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1261334 : 1261334;
        ...
        assert(block.hashMerkleRoot == uint256("0xe9f64907c7188b50d5e8f767fe67f2da0f26c42860955085b3424e6eeeb914a1"));
